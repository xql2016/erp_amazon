...
public class AutoPlaceSpamTrafficFromPlaceService {
    ...
    public static AutoPlaceRequest buildAutoPlaceRequest(SpamTrafficFromPlaceSearchCondition spamTrafficFromPlaceSearchCondition, Long hubId, List<HubPortfolioId> hubPortfolioIdList) {
        ...
        if(CollectionUtils.isNotEmpty(hubPortfolioIdList)) {
            ...
            if(null != hubPortfolioId && CollectionUtils.isNotEmpty(hubPortfolioId.getPortfolioIdList())) {
                autoPlaceRequest.setPortfolio_id(hubPortfolioId.getPortfolioIdList());
            }
        }
