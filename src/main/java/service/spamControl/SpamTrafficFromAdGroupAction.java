...
import model.configuration.spamTrafficFromAdGroup.*;
import model.enums.AdGroupType;
import model.enums.spamTrafficFromAdGroup.SpamTrafficFromAdGroupOperateType;
 ...
 * @since 2024/12/21
 */
public class SpamTrafficFromAdGroupAction extends AbstractSpamControlAction {

    @Override
    protected void execute(Configuration configuration) {
        // 获取配置
        SpamTrafficFromAdGroupConfiguration spamTrafficFromAdGroupConfiguration = configuration.getSpamTrafficFromAdGroupConfiguration();
    ...
    private AdGroupRequest buildAdGroupRequest(SpamTrafficFromAdGroupSearchCondition spamTrafficFromAdGroupSearchCondition, Long hubId, List<HubPortfolioId> hubPortfolioIdList) {
        ...
        if(CollectionUtils.isNotEmpty(hubPortfolioIdList)) {
            ...
            if(null != hubPortfolioId && CollectionUtils.isNotEmpty(hubPortfolioId.getPortfolioIdList())) {
                adGroupRequest.setPortfolio_id(hubPortfolioId.getPortfolioIdList());
            }
        }
