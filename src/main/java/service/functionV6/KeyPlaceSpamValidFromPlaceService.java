...
public class KeyPlaceSpamValidFromPlaceService {
    ...
    public static KeyPlaceRequest buildKeyPlaceRequest(SpamValidFromPlaceSearchCondition spamValidFromPlaceSearchCondition, Long hubId, List<Long> portfolioIdList) {
    ...
    public static void doOperation(KeyPlace keyPlace, SpamValidFromPlaceDoOperation spamValidFromPlaceDoOperation, Configuration configuration) {
        ...
        switch (SpamValidOperateType.getByValue(action.getSpamValidOperateType())) {
            ...
            case CPC_MULTIPLY_VALUE_DIVIDE_ACOS_SUB_VALUE:
                ...
                double bidChangeToC = Math.max((keyPlace.getCpc() * action.getCpcMultiplyValue()/ acos) - action.getSubValue(), action.getLagerThanValue());
