...
public class AsinPlaceSpamValidFromPlaceService {
    ...
    public static GoodsPlaceRequest buildGoodsPlaceRequest(SpamValidFromPlaceSearchCondition spamValidFromPlaceSearchCondition, Long hubId, List<Long> portfolioIdList, String expressionType) {
