...
public class AsinPlaceSpamTrafficFromPlaceService {
    ...
    public static GoodsPlaceRequest buildGoodsPlaceRequest(SpamTrafficFromPlaceSearchCondition spamTrafficFromPlaceSearchCondition, Long hubId, List<Long> portfolioIdList, String expressionType) {
